let TextileModel;_1e6‍.x([["addDefault",()=>addDefault],["addFabrics",()=>addFabrics],["getTitles",()=>getTitles],["getFabrics",()=>getFabrics],["getActiveProducts",()=>getActiveProducts],["getHiddenProducts",()=>getHiddenProducts],["getFabricsByCategory",()=>getFabricsByCategory],["getFabric",()=>getFabric],["deleteFabric",()=>deleteFabric],["updateFabrics",()=>updateFabrics],["activateProduct",()=>activateProduct],["hideProduct",()=>hideProduct]]);_1e6‍.w("../Models/textile",[["default",["TextileModel"],function(v){TextileModel=v}]]);
...
const getCategoryByIndex = (value) => {
  ...
  try {
    _1e6‍.g.console.log("delete id: " + req.params.id)
  ...
  try {
    _1e6‍.g.console.log("id: " + req.params.id)
    _1e6‍.g.console.log("body: " + JSON.stringify(req.body))
    ...
    try {  
      _1e6‍.g.console.log("activation: " + req.params.id)
      _1e6‍.g.console.log("body: " + JSON.stringify(req.body))
    ...
    try {  
      _1e6‍.g.console.log("hide: " + req.params.id)
      _1e6‍.g.console.log("body: " + JSON.stringify(req.body))
