let TextileModel;_8dc‍.x([["addDefault",()=>addDefault],["addFabrics",()=>addFabrics],["getTitles",()=>getTitles],["getFabrics",()=>getFabrics],["getActiveProducts",()=>getActiveProducts],["getHiddenProducts",()=>getHiddenProducts],["getFabricsByCategory",()=>getFabricsByCategory],["getFabric",()=>getFabric],["deleteFabric",()=>deleteFabric],["updateFabrics",()=>updateFabrics],["activateProduct",()=>activateProduct],["hideProduct",()=>hideProduct]]);_8dc‍.w("../Models/textile",[["default",["TextileModel"],function(v){TextileModel=v}]]);
...
const record =  (data) =>{
  ...
  try {
    _8dc‍.g.console.log("delete id: " + req.params.id)
  ...
  try {
    ...
    _8dc‍.g.console.log("id: " + req.params.id)
    _8dc‍.g.console.log("body: " + JSON.stringify(req.body))
    ...
    try {
      ...
      _8dc‍.g.console.log("activation: " + req.params.id)
      _8dc‍.g.console.log("body: " + JSON.stringify(req.body))
    ...
    try {
      ...
      _8dc‍.g.console.log("hide: " + req.params.id)
      _8dc‍.g.console.log("body: " + JSON.stringify(req.body))
