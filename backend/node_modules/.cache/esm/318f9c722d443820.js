let OrderModel,moment;_2d4‍.x([["addOrder",()=>addOrder],["getOrders",()=>getOrders],["getActivedOrders",()=>getActivedOrders],["getHiddenOrders",()=>getHiddenOrders],["hideOrder",()=>hideOrder],["activateOrder",()=>activateOrder]]);_2d4‍.w("../Models/order",[["default",["OrderModel"],function(v){OrderModel=v}]]);_2d4‍.w("moment",[["default",["moment"],function(v){moment=v}]]);
...
const getWrap = ( status, msg, json ) =>{
  return ({  
    ...
    try {
      ...
      res.status(404).send(error)
       ...
       const getActivedOrders = async (req, res) => {
  try {
    ...
    res.status(404).send(error)
       ...
       const getHiddenOrders = async (req, res) => {
  try {
  ...
  try {
    _2d4‍.g.console.log("activation: " + req.params.id)
    _2d4‍.g.console.log("body: " + JSON.stringify(req.body))
